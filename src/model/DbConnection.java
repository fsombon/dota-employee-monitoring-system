...
public class DbConnection {
    ...
    static final String DB_NAME = "monitoringsystem";
    static final String DB_SERVER = "127.0.0.1";
    ...
    public static Connection getDbConnection() {
        ...
        try {
            ...
            //conn = DriverManager.getConnection(DB_URL + "" + DB_NAME, DB_USER_NAME, DB_PASSWORD);
             String url = "jdbc:mysql://" + DB_SERVER + "/" + DB_NAME + "?max_connections=" + MAX_CONNECTIONS;
